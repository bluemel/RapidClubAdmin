...
public class ModeTablelBeans<T> extends AbstractTableModel {
     ...
     */
    public ModeTablelBeans(final Document doc,
            final String typenam,
    ...
    public Object getValueAt(final int rowIndex, final int columnIndex) {
        ...
        if (bean instanceof Trainer) {
            ...
            case 1:
                ...
                break;
            default:
                throw new RapidBeansRuntimeException("Error in getValueAt("
                        + rowIndex + ", " + columnIndex
                        + "): undefinded column " + columnIndex + "\n"
...
//                ret = ((Department) bean).getName();
    ...
    /**
     * update the trainers after Trainers were added or deleted or the
