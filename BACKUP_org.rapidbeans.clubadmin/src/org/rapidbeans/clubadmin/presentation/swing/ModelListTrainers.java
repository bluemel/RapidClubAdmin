...
public class ModelListTrainers extends ModelListBeans {
     ...
     * 1) Role Trainer: show only the associated trainer
     * 2) Role Departmentadministrator: show only the trainers of associated departments
     ...
     *
     * @param instances the departments for which parent clubs should
     *        be filtered.
     */
