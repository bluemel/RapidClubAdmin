...
public class EditorPropertySalaryComponentMoney extends EditorPropertyMoneySwing {
     ...
     */
    public EditorPropertySalaryComponentMoney(Application client, EditorBean bizBeanEditor, Property prop, Property propBak) {
        super(client, bizBeanEditor, prop, propBak);
    }


    /**
     * Adapt the SalaryComponent's money currency according to the future
     * parent Salary's currency.
     */
