...
public abstract class ModelListBeans extends AbstractListModel {
    ...
    /**
     * fill the authorization filter part according to the user
     * and its role.
     */
    protected abstract void fillAuthorizationFilterPart(ClubadminUser user, Role role,
            StringBuffer buf);

    /**
     * @return the authorization part of the filter or null
     *         if there is no authorization restriction
     */
     ...
     */
    public ModelListBeans(final Document doc,
    ...
    /**
     * update the model after beans were added or deleted or the
