...
public final class ViewTrainings extends DocumentView {
    ...
    public ViewTrainings(final Application client, final Document doc, final String docconfname,
        ...
        if (icon == null) {
            icon = ((MainWindowSwing) client.getMainwindow()).getIconManager().getIcon(
                    "view.trainingslist.trainings.icon");
        }
        if (icon != null) {
        ...
        this.trainingPartcountLabel.setText(locale
                .getStringGui("bean.org.rapidbeans.clubadmin.domain.training.prop.partipiciantscount"));
        ...
        this.trainingLastEditedByLabel.setText(locale
                .getStringGui("bean.org.rapidbeans.clubadmin.domain.training.prop.checkedbyuser"));
        this.trainingLastEditedAtLabel.setText(locale
                .getStringGui("bean.org.rapidbeans.clubadmin.domain.training.prop.checkeddate"));
     ...
     * 
     * @param keys
     *            the tree paths to identify the edited object
     * @param beans
     *            the selected beans
     * 
     ...
     *            the parent bean of the new bean
     * 
                    ...
                    if (trhbt.getTrainer() != null) {
                        e1 = new RapidClubAdminBusinessLogicException(
                                ...
                                "Trainings held by trainers must have a trainer role set.", new Object[] { trhbt
                                        .getTrainer().getLastname() + ',' + trhbt.getTrainer().getFirstname() });
                    } else {
                        e1 = new RapidClubAdminBusinessLogicException(
                                "invalid.training.state.transition.checked.nullrole",
    ...
    private void updateTraining(final Training training) {
        ...
        if (user == null) {
            ...
            this.trainingLastEditedAtTextField.setText(DateFormat.getDateTimeInstance(DateFormat.MEDIUM,
                    DateFormat.SHORT).format(chdate));
        }
     ...
     * 
     * @param trainingShown
     *            the training currently presented
     */
    private void updateButtons(final Training trainingShown) {
        ...
        if (trainingShown != null) {
            ...
            case closed:
                ...
                break;
            default:
                throw new RapidBeansRuntimeException("Unexpected TrainigState" + ", order = "
                        + trainingShown.getState().ordinal());
            }
        } else {
            buttonToggleCancelledLabelKey = "trainingslist.trainings.button.cancel.label";
            buttonToggleCancelledTooltipKey = "trainingslist.trainings.button.cancel.tooltip";
     ...
     * 
     * @param scrollTo
     *            scroll to this Training if set to true
     */
    private void selectFirstTrainingToWorkOn(final boolean scrollTo) {
        ...
        final Query query = new Query("org.rapidbeans.clubadmin.domain.Training["
                + "state = 'asplanned' | state = 'modified']");
        // sort by date
