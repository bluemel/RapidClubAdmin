...
public class RendererTrainings implements TableCellRenderer {
     ...
     */
    private static final ImageIcon ICON_0_TRAINING_DEFAULT =
        new ImageIcon(RapidClubAdmin.class.getResource(
            "presentation/pictures/training0Default.png"));

    /**
     * Symbol for: training has been modified (is not default).
     */
    private static final ImageIcon ICON_1_TRAINING_MODIFIED =
        new ImageIcon(RapidClubAdmin.class.getResource(
            "presentation/pictures/training1InWork.png"));

    /**
     * Symbol for: training has been checked (is O.K.).
     */
    private static final ImageIcon ICON_2_TRAINING_CHECKED =
        new ImageIcon(RapidClubAdmin.class.getResource(
            "presentation/pictures/training2Checked.png"));

    /**
     * Symbol for: training has been cancelled.
     */
    private static final ImageIcon ICON_3_TRAINING_CANCELLED =
        new ImageIcon(RapidClubAdmin.class.getResource(
            "presentation/pictures/training3Cancelled.png"));

    /**
     * Symbol for: the training has been not scheduled because the location
     *             was closed.
     */
    private static final ImageIcon ICON_4_TRAINING_CLOSED =
        new ImageIcon(RapidClubAdmin.class.getResource(
            "presentation/pictures/training4Closed.png"));
