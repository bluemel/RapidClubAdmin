...
/**
 * Rapid Bean class: SalaryComponent.
...
public class SalaryComponent extends RapidBeanImplStrict {
    ...
    public void initProperties() {
        this.salaryComponentType = (org.rapidbeans.core.basic.PropertyAssociationend)
            this.getProperty("salaryComponentType");
        this.description = (org.rapidbeans.core.basic.PropertyString)
            this.getProperty("description");
        this.money = (org.rapidbeans.core.basic.PropertyQuantity)
            this.getProperty("money");
        this.time = (org.rapidbeans.core.basic.PropertyQuantity)
    ...
    public SalaryComponentType getSalaryComponentType() {
        try {
            org.rapidbeans.core.common.ReadonlyListCollection<SalaryComponentType> col
                = (org.rapidbeans.core.common.ReadonlyListCollection<SalaryComponentType>) this.salaryComponentType.getValue();
     ...
     */
    public void setSalaryComponentType(
        final SalaryComponentType argValue) {
    ...
    public void setMoney(
        final org.rapidbeans.domain.finance.Money argValue) {
     ...
     */
    public void setTime(
        final org.rapidbeans.domain.math.Time argValue) {
