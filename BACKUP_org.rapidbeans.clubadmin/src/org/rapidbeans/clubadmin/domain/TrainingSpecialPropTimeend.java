...
/**
 * extends quantity property TrainingSpecial.timeend.
 */
public class TrainingSpecialPropTimeend extends PropertyQuantity {
     ...
     */
    public TrainingSpecialPropTimeend(final TypeProperty type, final RapidBean parentBean) {
    ...
    public TimeOfDay validate(final Object newValue) {
        ...
        ((Training) this.getBean()).validateTimeend(time);
        return time;
    }
}
