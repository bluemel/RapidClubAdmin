 ...
 */
public class TrainingDatePropTimestart extends PropertyQuantity {
     ...
     */
    public TrainingDatePropTimestart(final TypeProperty type, final RapidBean parentBean) {
    ...
    public TimeOfDay validate(final Object newValue) {
        ...
        ((TrainingDate) this.getBean()).validateTimestart(time);
        return time;
    }
}
