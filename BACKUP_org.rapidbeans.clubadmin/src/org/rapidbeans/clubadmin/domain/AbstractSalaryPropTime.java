...
public class AbstractSalaryPropTime extends PropertyQuantity {
    ...
    public Time validate(final Object newValue) {
        ...
        if (time == null) {
            ...
            if (money != null) {
                throw new ValidationException("invalid.prop.salary.time.null",
                        this,
                        "invalid null value for property \"time\""
                        + " because property \"money\" != null");
            }
        }
        return time;
    }
    ...
    /**
     * Overrides the set value method of PropertyQuantity
