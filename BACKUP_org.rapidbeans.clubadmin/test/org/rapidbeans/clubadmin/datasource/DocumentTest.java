...
public final class DocumentTest extends TestCase {
    ...
    public void testMasterdata1() {
        new Document(new File("testdata/masterdata1.xml"));
    }
    ...
    public void testDeleteTraining() throws ParseException{
        ...
        TrainingRegular tr = (TrainingRegular) doc.findBean("org.rapidbeans.clubadmin.domain.Training",
                "Budo-Club Ismaning/Aikido/monday_20:30_Turnhalle Grundschule Süd/20061106");
        assertNotNull(tr);
        tr.delete();
    ...
    public void testDeleteTrainer() throws ParseException{
        ...
        Trainer tr = (Trainer) doc.findBean("org.rapidbeans.clubadmin.domain.Trainer",
                "Blümel_Martin_");
        assertNotNull(tr);
        tr.delete();
     ...
     * Because the component is part of a document it
     * is automatically deleted there. This includes
     * breaking references to that orphaned component.
     * @throws MalformedURLException 
     */
    public void testRemoveLinkComponentDeleteOrphanedFromDoc_nton()
        throws MalformedURLException {
        ...
        assertSame(wembley, doc.findBeansByType(
                "org.rapidbeans.clubadmin.domain.Location").get(0));
        assertSame(summerHolidays, doc.findBeansByType(
                "org.rapidbeans.clubadmin.domain.ClosingPeriod").get(0));
        ...
        assertSame(wembley, doc.findBeansByType(
                "org.rapidbeans.clubadmin.domain.Location").get(0));
        assertEquals(0, doc.findBeansByType(
                "org.rapidbeans.clubadmin.domain.ClosingPeriod").size());
        assertEquals(0, wembley.getClosedons().size());
        assertEquals(0, summerHolidays.getLocations().size());
        File docfile = new File("testdata/testDocFile.xml");
        doc.setUrl(docfile.toURI().toURL());
        doc.save();

        doc = new Document(docfile);
        bp = (MasterData) doc.getRoot();
        wembley = (Location) doc.findBean(
                "org.rapidbeans.clubadmin.domain.Location", "Wembley");
        summerHolidays = (ClosingPeriod) doc.findBean(
                "org.rapidbeans.clubadmin.domain.ClosingPeriod", "20080701_Summer Holydays");
    ...
    public void testSetupTestTrainingsListDoc() throws ParseException {
        ...
        Trainer martin = (Trainer) doc.findBean(
                "org.rapidbeans.clubadmin.domain.Trainer", "Blümel_Martin_");
        assertEquals("Blümel_Martin_", martin.getIdString());
        RapidBean periodWithTrainerMartin =
            doc.findBeanByQuery(
                "org.rapidbeans.clubadmin.domain.TrainingsList[trainers[lastname = 'Blümel']]");
        assertSame(period, periodWithTrainerMartin);

        assertEquals(1, ((Department) ((Club) period.getClubs().iterator().next())
                .getDepartments().iterator().next()).getTrainingdates().size());
    }
    ...
    public void testSetupTestMasterDataDoc() throws ParseException {
        ...
        RapidBean periodWithTrainerMartin =
            doc.findBeanByQuery(
                "org.rapidbeans.clubadmin.domain.MasterData[trainers[lastname = 'Blümel']]");
        assertSame(period, periodWithTrainerMartin);
    }
    ...
    private Document setupTestTrainingsListDocument() throws ParseException {
        ...
        Trainer martin = new Trainer("\"Blümel\" \"Martin\"");
        //martin.setCreditinstitute(hvb);
        period.addTrainer(martin);

        Trainer chris = new Trainer("\"Höppner\" \"Christop\"");
        ...
        Location loc = new Location("\"Turnhalle Grundschule Süd\"");
        ...
        TrainingDate aikidoMonday = new TrainingDate(
                "\"monday\" \"20:30\" \"Turnhalle Grundschule Süd\"");
    ...
    public void testWriteAndRead() throws IOException {
        ...
        assertSame(TreeSet.class, ((TypePropertyCollection) td.getProperty("trainings").getType()).getCollectionClass());
        td.setLocation(loc);
        ...
        File testfilesrc = new File("testdata/trainingslist_20060101_20060331.xml");
        ...
        File testfile = new File("testdata/testdoc.xml");
    ...
    public void testDetectProblemWithSortedTrainings() {
        Document doc = new Document(new File("testdata/trainingslist_20060101_20060331.xml"));
    ...
    public void testReadInitMasterData() {
        final Document doc = new Document(new File(
                "testdata/config/initial/data/masterdata.xml"));
        assertNotNull(doc.findBean("org.rapidbeans.clubadmin.domain.ClubadminUser",
                "administrator"));
    }
}
