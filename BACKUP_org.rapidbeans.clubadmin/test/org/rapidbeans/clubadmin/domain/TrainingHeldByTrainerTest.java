 ...
 */
public class TrainingHeldByTrainerTest extends TestCase {

    /**
     * Test method for {@link org.rapidbeans.clubadmin.domain.TrainingHeldByTrainer#TrainingHeldByTrainer()}.
     */
    ...
    /**
     * Test method for setStrainer.
     * Prooves that you can assing two different trainer to one and
     * the same training.
     */
    ...
    /**
     * Prooves that you can assing one and the same trainer to two
     * different trainings at the same date but on non overlapping time.
     */
    ...
    /**
     * Test method for getTrainer().
     * Prooves that you get a validation exception if you try
     * to assing a trainer to the same training twice.
     */
     ...
     * Test method for getTrainer().
     * Prooves that you get a validation exception if you try
     * to assing a trainer to the training that is alread assigne to another
     ...
     * @return the training.
     */
    private TrainingRegular createTraining(final TrainerRole rTrainer, final String date,
            final String day, final String timeBegin, final String timeEnd,
