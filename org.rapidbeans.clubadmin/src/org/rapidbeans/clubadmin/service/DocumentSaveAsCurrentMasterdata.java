...
/**
 * The action to save current document as the file
 * defined in the program settings.<br/>
...
public class DocumentSaveAsCurrentMasterdata extends Action {
    ...
    /**
     * Drives the action to save the masterdata current document
     * to local file or central web store.
     *
     * This action potentially overwrites data
     */
    public void execute() {
