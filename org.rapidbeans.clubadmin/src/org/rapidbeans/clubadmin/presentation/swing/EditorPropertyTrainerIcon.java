...
public class EditorPropertyTrainerIcon extends EditorPropertySwing {
     ...
     */
    public EditorPropertyTrainerIcon(final Application client,
        ...
        this.button.setText(client.getCurrentLocale().getStringGui(
                "editor.org.rapidbeans.clubadmin.domain.trainer.icon.button.set"));
        ...
        this.buttonReset.setText(client.getCurrentLocale().getStringGui(
                "editor.org.rapidbeans.clubadmin.domain.trainer.icon.button.reset"));
        ...
        this.panel.add(this.buttonIcon, new GridBagConstraints(
                0, 0, 1, 2, 1.0, 0.0,
...
//        }
    ...
    public String getInputFieldValueString() {
        ...
        if (trainer.getIcon() == null) {
            ...
            return PropertyDate.formatDate(trainer.getIcon(),
                ApplicationManager.getApplication().getCurrentLocale());
        }
    }
    ...
    private void chooseFile() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            client.getTrainerIcons().importIcon(
                    (Trainer) this.getProperty().getBean(), file);
