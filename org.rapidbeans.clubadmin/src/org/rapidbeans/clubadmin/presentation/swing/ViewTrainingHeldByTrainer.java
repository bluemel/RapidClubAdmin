...
/**
 * Presents a single TrainingHeldByTrainer object which is
 * a trainer that took part on a certain training in a special
 * role.
 *
...
public class ViewTrainingHeldByTrainer extends JPanel {
    ...
    public ViewTrainingHeldByTrainer(final TrainingHeldByTrainer trhbt,
        ...
        try {
            ...
            this.comboBoxTrainerName.setRenderer(
                    new RendererListCollection(
                            trhbt.getContainer(), locale));
            ...
            this.comboBoxTrainerRole.setModel(new ModelComboBoxCollection(
                    ...
                    (Collection<RapidBean>) (((Collection<?>) ((TrainingsList) ((Document) trhbt.getContainer()).getRoot()).getTrainerroles()))));
            }
            this.comboBoxTrainerRole.setRenderer(new RendererListCollection(
                    trhbt.getContainer(), locale));
            ...
            if (parentTraining != null) {
                ...
                if (parentDepartment != null) {
                    ...
                    this.comboBoxTrainerName.setModel(
                            new ModelComboBoxCollection(
                            (TypePropertyCollection) trhbt.getProperty("trainer").getType(),
            ...
            this.popupMenuItemDelete.setText(
                    locale.getStringGui("commongui.text.delete"));
    ...
    private void dataBindingChangeTrainer(final ItemEvent itemEvent) {
        ...
        if (itemEvent.getStateChange() != 1
                && this.comboBoxTrainerName.getSelectedItem() != null) {
            return;
        }
        try {
            this.setUiEventLock();
    ...
    private void dataBindingChangeRole(final ItemEvent itemEvent) {
        ...
        try {
            this.setUiEventLock();
            this.trainingHeldByTrainer.setRole(
                    (TrainerRole) this.comboBoxTrainerRole.getSelectedItem());
            this.updateComboBoxes();
        } catch (ValidationException e) {
            final Application client = ApplicationManager.getApplication();
            final RapidBeansLocale locale = client.getCurrentLocale();
    ...
    public void beanAdded(final AddedEvent e) {
        if (e.getBean() instanceof TrainerRole) {
            this.comboBoxTrainerRole.setModel(new ModelComboBoxCollection(
                    ...
                    (Collection<RapidBean>) (((Collection<?>) ((TrainingsList) ((Document) this.trainingHeldByTrainer.getContainer()).getRoot()).getTrainerroles()))));
            this.dataBindingUpdateUI();
        }
    }
                        ...
                        for (PropertyChangeEvent pce : e.getPropertyEvents()) {
                            if (pce.getProperty() == dep.getProperty("trainers")) {
                                this.comboBoxTrainerName.setModel(new ModelComboBoxCollection(
                                        (TypePropertyCollection) this.trainingHeldByTrainer.getProperty("trainer").getType(),
     ...
     * during updating the UI according to a bean's contents.
     */
