...
/**
 * Rapid Bean class: RapidClubAdminSettings.
...
public class RapidClubAdminSettings extends org.rapidbeans.presentation.settings.Settings {
    ...
    public void initProperties() {
        ...
        this.backupfolder = (org.rapidbeans.core.basic.PropertyFile)
            this.getProperty("backupfolder");
        this.exportfile = (org.rapidbeans.core.basic.PropertyFile)
            this.getProperty("exportfile");
        this.reportfolder = (org.rapidbeans.core.basic.PropertyFile)
            this.getProperty("reportfolder");
        this.defaultdatafileloadinitially = (org.rapidbeans.core.basic.PropertyBoolean)
            this.getProperty("defaultdatafileloadinitially");
        this.workingdepartment = (org.rapidbeans.core.basic.PropertyString)
            this.getProperty("workingdepartment");
        this.shareiconsoverweb = (org.rapidbeans.core.basic.PropertyBoolean)
            this.getProperty("shareiconsoverweb");
        this.pleasedontnag = (org.rapidbeans.core.basic.PropertyBoolean)
            this.getProperty("pleasedontnag");
    }
     ...
     */
    public void setDefaultdatafileloadinitially(
     ...
     */
    public void setWorkingdepartment(
     ...
     */
    public void setShareiconsoverweb(
        final boolean argValue) {
