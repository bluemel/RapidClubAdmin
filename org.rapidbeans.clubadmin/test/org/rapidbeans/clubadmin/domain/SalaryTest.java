...
public class SalaryTest extends TestCase {
   ...
   /**
    ...
    /**
     ...
     /**
      * - A component automatically gets the time of the
      *   parent salary.
      */
     ...
     /**
      * - The composite Salary automatically adapts to the sum of
      *   the components salaries.
      */
     ...
     /**
      * - All components automatically adapt their time if the composite
      *   Salary changes its time.
      */
