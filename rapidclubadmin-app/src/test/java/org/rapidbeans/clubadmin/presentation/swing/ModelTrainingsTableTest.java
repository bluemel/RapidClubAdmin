...
public class ModelTrainingsTableTest {
	...
	public void testSortTrainings() {
		Document doc = new Document(new File("src/test/resources/trainingslist_withSpecialTrainings.xml"));
		...
		final TypeProperty[] proptypes = { tr01.getProperty("date").getType(),
	...
	public void testModelSorting() {
		...
		assertEquals("Budo-Club Ismaning/Aikido/8:15_Turnhalle Grundschule S" + Umlaut.L_UUML + "d_20070904",
		...
		assertEquals("Budo-Club Ismaning/Aikido/22:00_Turnhalle Grundschule S" + Umlaut.L_UUML + "d_20070904",
