...
public class RapidClubAdminClientIntegrationTest {
	...
	public void testCreateNewTrainingsList() {
		Document doc = CreateTrainingsList.createNewTrainingsList(client.getMasterDoc(), null);
		assertNotNull(doc);
	}
	...
	public void testBPUpdateClosingPeriods() throws ParseException {
		...
		Document doc = CreateTrainingsList.createNewTrainingsList(client.getMasterDoc(), null);
		TrainingsList bp = (TrainingsList) doc.getRoot();
		List<RapidBean> cps = doc.findBeansByType("org.rapidbeans.clubadmin.domain.ClosingPeriod");
