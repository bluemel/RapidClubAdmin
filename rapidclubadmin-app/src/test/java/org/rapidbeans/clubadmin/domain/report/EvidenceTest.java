...
public class EvidenceTest {
	...
	public void testReadTemplate() throws IOException {
		Template tmpl = Evidence.readTemplate(new File("src/test/resources/testevidence/templateEvidence.rtf"));
		File testfile = new File("src/test/resources/testevidence/test.rtf");
		...
		out.close();
		assertTrue(FileHelper.filesEqual(testfile, new File("src/test/resources/testevidence/templateEvidence1x2.rtf"),
				true, true));
	...
	public void testDetermineRowCount32() throws IOException {
		Template tmpl = Evidence.readTemplate(new File("src/test/resources/testevidence/templateEvidence32.rtf"));
	...
	public void testReportDepartmentSimple() throws IOException {
		...
		Document testdoc = new Document(new File("src/test/resources/testevidence/trainingsDataAikido.xml"));
		...
		File testfile = new File("src/test/resources/testevidence/testreport.rtf");
		File expected = new File("src/test/resources/testevidence/resultEvidenceDepartmentSimple.rtf");
		File template = new File("src/test/resources/testevidence/templateEvidence.rtf");
		Evidence.printReportEvidence(testfile, template, department, trainer, true);
		assertTrue("Test file " + testfile.getAbsolutePath() + " does not equal reference file "
	...
	public void testReportOverflowDepartmentSingle() throws IOException {
		...
		Department department = (Department) testdoc.findBean(Department.class.getName(), "Budo-Club Ismaning/Aikido");
		File testfile = new File("src/test/resources/testevidence/testreport.rtf");
		File expected = new File("src/test/resources/testevidence/resultEvidenceOverflowDepartmentSingle.rtf");
		File template = new File("src/test/resources/testevidence/templateEvidence.rtf");
		Evidence.printReportEvidence(testfile, template, department, trainer, true);
	...
	public void testReportOverflowDepartmentCoherent() throws IOException {
		...
		Department department = (Department) testdoc.findBean(Department.class.getName(), "Budo-Club Ismaning/Aikido");
		File testfile = new File("src/test/resources/testevidence/testreport.rtf");
		File expected = new File("src/test/resources/testevidence/resultEvidenceOverflowDepartmentCoherent.rtf");
		File template = new File("src/test/resources/testevidence/templateEvidence.rtf");
	...
	public void testReportOverflowDepartmentsCoherent() throws IOException {
		...
		File testfile = new File("src/test/resources/testevidence/testreport.rtf");
		File expected = new File("src/test/resources/testevidence/resultEvidenceOverflowDepartmentsCoherent.rtf");
		File template = new File("src/test/resources/testevidence/templateEvidence.rtf");
	...
	public void testReportCollected() throws IOException {
		...
		Department dep2 = (Department) testdoc2.findBean(Department.class.getName(), "Budo-Club Ismaning/Karate");
		File testfile = new File("src/test/resources/testevidence/testreport.rtf");
		File expected = new File("src/test/resources/testevidence/resultEvidenceCollected.rtf");
		File template = new File("src/test/resources/testevidence/templateEvidence.rtf");
	...
	private class ApplicationMock extends RapidClubAdminClient {
		...
		public void start() {
			...
			this.setRoot("src/test/resources");
		}

		@Override
		public RapidClubAdminSettings getSettingsRapidClubAdmin() {
			Settings settings = (Settings) new Document(new File("src/test/resources/testsettings.xml")).getRoot();
