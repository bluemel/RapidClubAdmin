 ...
 */
public class ClosingPeriodTest {

	/**
	 * Test method for
	 * {@link org.rapidbeans.clubadmin.domain.ClosingPeriod#ClosingPeriod()}.
	 */
	@Test
	...
	/**
	 * Test constructing a valid closing period giving same "from" and "to" date.
	...
	/**
	 * Test constructing a valid closing period giving different "from" and "to"
	 * date. Attribute "oneday" is supposed to be 'false' automatically.
	 *
	 * @throws ParseException if parsing the test dates fails
	 */
	@Test
	...
	/**
	 * Test constructing a valid closing period giving different "from" and "to" and
	 * setting also "oneday" = 'false' accordingly.
	 *
	 * @throws ParseException if parsing the test dates fails
	 */
	@Test
	...
	/**
	 * Test constructing a valid closing period giving different "from" and "to" but
	 * setting also "oneday" = 'true' Attribute "to" is supposed to be same as from.
	 *
	 * @throws ParseException if parsing the test dates fails
	 */
	@Test
	...
	/**
	 * Setting "oneday" to 'true' makes the to date equals to the "from" date.
	 *
	 * @throws ParseException if parsing the test dates fails
	 */
	@Test
...
//    }
	...
	/**
	 * Test constructing a date with an invalid combination of properties (from <
	 * to).
	 *
	 * @throws ParseException if parsing the test dates fails
	 */
