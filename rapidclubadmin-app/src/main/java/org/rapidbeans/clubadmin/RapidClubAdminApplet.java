 ...
 */
public final class RapidClubAdminApplet extends JApplet implements Appl {
	...
	private static final Logger log = Logger.getLogger(RapidClubAdminApplet.class.getName());
