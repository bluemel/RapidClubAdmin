/*
 * RapidBeans Application RapidClubAdmin: TrainingRegularPropTimestart.java
 *
 ...
 */
public class TrainingRegularPropTimestart extends PropertyQuantity {
	 ...
	 */
	public TrainingRegularPropTimestart(final TypeProperty type, final RapidBean parentBean) {
	...
	public TimeOfDay getValue() {
		...
		if (trd != null) {
			t = (TimeOfDay) trd.getPropValue("timestart");
		}
		return t;
	}
	...
	public void setValue(final Object value) {
		...
		final TrainingDate trd = (TrainingDate) tr.getParentBean();
		if (trd != null) {
			trd.setPropValue("timestart", value);
		}
	}
}
