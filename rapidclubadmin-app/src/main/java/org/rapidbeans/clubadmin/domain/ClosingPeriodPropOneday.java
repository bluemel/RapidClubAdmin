...
//        }
	...
	/**
	 * Overwrite the generic value setter in order to react on changes. If the from
	 * date is given at the time this property is set the to date is set equal to
	 * the from date. Accepts the following data types:<br/>
