...
/**
 * The action to save current Billing Period document as the file defined in the
 * program settings web (central) or local (decentral).<br/>
 *
...
public class DocumentSaveAsCurrentTrainingsList extends Action {
	...
	/**
	 * Drives the action to save the active document as the current billing period.
	 *
	 * This action potentially overwrites data.
	 */
	public void execute() {
