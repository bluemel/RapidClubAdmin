...
public class Settings extends org.rapidbeans.presentation.settings.SettingsAll {
	...
	public void initProperties() {
		...
		this.settings = (org.rapidbeans.core.basic.PropertyAssociationend) this.getProperty("settings");
	...
	public org.rapidbeans.clubadmin.presentation.RapidClubAdminSettings getSettings() {
		try {
			org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.RapidClubAdminSettings> col = (org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.RapidClubAdminSettings>) this.settings
					.getValue();
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.clubadmin.presentation.RapidClubAdminSettings"
									+ "\" \"" + link.getIdString() + "\"");
				} else {
	 ...
	 */
	public void setSettings(final org.rapidbeans.clubadmin.presentation.RapidClubAdminSettings argValue) {
	...
	public org.rapidbeans.clubadmin.presentation.SettingsBasic getBasic() {
		try {
			org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.SettingsBasic> col = (org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.SettingsBasic>) this.basic
					.getValue();
			if (col == null || col.size() == 0) {
				return null;
			} else {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.clubadmin.presentation.SettingsBasic" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 */
	public void setBasic(final org.rapidbeans.clubadmin.presentation.SettingsBasic argValue) {
