...
public class EnablerOpenCurrentTrainingsList extends Enabler {
	...
	public EnablerOpenCurrentTrainingsList(final MainWindow mainWindow, final Department department) {
	...
	public boolean getEnabled() {
		...
		final TrainingsList trlist = (TrainingsList) this.mainWindow.getActiveDocument().getRoot();
