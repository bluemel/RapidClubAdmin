...
/**
 * Rapid Bean class: IconInfoList. Partially generated Java class !!!Do only
...
public class IconInfoList extends RapidBeanImplStrict {
	...
	private static final Logger log = Logger.getLogger(IconInfoList.class.getName());

	private static DateFormat logDateFormat = DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.MEDIUM);
	...
	public void markIconUpdate(final Trainer trainer) {
		...
		if (info == null) {
			...
			log.fine("markIconUpdate: found info, last upload: " + logDateFormat.format(info.getLastupload()) + "\"");
		}
		info.setLastupload(new Date());
		log.fine("markIconUpdate: updated info, last upload: " + logDateFormat.format(info.getLastupload()));
	}
	...
	public void initProperties() {
		this.icons = (org.rapidbeans.core.basic.PropertyAssociationend) this.getProperty("icons");
	}
	...
	public org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.IconInfo> getIcons() {
		try {
			return (org.rapidbeans.core.common.ReadonlyListCollection<org.rapidbeans.clubadmin.presentation.IconInfo>) this.icons
					.getValue();
	 ...
	 */
	public void setIcons(final java.util.Collection<org.rapidbeans.clubadmin.presentation.IconInfo> argValue) {
