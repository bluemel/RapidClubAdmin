...
public class DocumentViewUserSelfAdmin extends DocumentViewSwing {
	 ...
	 */
	public DocumentViewUserSelfAdmin(final Application client, final Document doc, final String docconfname,
			final String viewconfname, final Filter filter) {
		super(client, doc, docconfname, viewconfname, filter);
	}

	/**
	 * If the (one and only) bean editor for user self admin is closed automatically
	 * also close this surrounding document view.
	 *
