...
//        new ArrayList<TrainingHeldByTrainer>();
	 ...
	 */
	private Map<TrainingHeldByTrainer, ViewTrainingHeldByTrainer> trhbtViews = new HashMap<TrainingHeldByTrainer, ViewTrainingHeldByTrainer>();
	 ...
	 * @param training the training to present
	 */
	ViewTrainingHeldByTrainerList(final ViewTrainings parentView, final Training training) {
	...
	public void selectTrainingHeldByTrainer(final ViewTrainingHeldByTrainer trhbtView) {
		if (this.selectedTrainingHeldByTrainer != null) {
			final ViewTrainingHeldByTrainer trhbtViewSelBefore = this.trhbtViews
					.get(this.selectedTrainingHeldByTrainer);
	...
	public void updateUI() {
		...
		if (this.trainingToPresent != null) {
			...
			case checked:
				if (this.trainingToPresent != null) {
					for (TrainingHeldByTrainer trhbt : this.trainingToPresent.getHeldbytrainersSortedByValue()) {
	...
	public void beanAdded(final AddedEvent e) {
		if (e.getBean() instanceof TrainingHeldByTrainer) {
			final Training tr = (Training) ((TrainingHeldByTrainer) e.getBean()).getParentBean();
	...
	public void bizBeanChanged(final ChangedEvent e) {
		...
		} else if (e.getBean() instanceof Department && this.trainingToPresent != null
