...
public class ModelTrainingsTable extends AbstractTableModel {
	...
	/**
	 * update the trainings after Trainings were added or deleted or the filter has
	 * been changed.
	 */
	private void updateTrainings() {
		final Query query = new Query("org.rapidbeans.clubadmin.domain.Training >date >timestart");
