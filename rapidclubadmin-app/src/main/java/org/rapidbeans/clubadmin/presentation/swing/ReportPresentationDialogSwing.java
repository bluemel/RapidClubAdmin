 ...
 * MainWindow.
 */
public class ReportPresentationDialogSwing {
	 ...
	 */
	public ReportPresentationDialogSwing(final String reportText, final String title) {
		...
		this.textArea.setText(reportText);
	}
