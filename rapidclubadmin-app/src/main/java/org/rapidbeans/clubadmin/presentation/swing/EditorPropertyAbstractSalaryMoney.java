 ...
 */
public class EditorPropertyAbstractSalaryMoney extends EditorPropertyMoneySwing {
	 ...
	 */
	public EditorPropertyAbstractSalaryMoney(Application client, EditorBean bizBeanEditor, Property prop,
			Property propBak) {
	...
	/**
	 * Appends some action to the update handler. Input is forbidden as long as the
	 * AbstractSalary has components.
	 */
	@Override
