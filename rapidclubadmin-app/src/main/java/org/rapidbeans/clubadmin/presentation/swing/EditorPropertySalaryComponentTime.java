 ...
 */
public class EditorPropertySalaryComponentTime extends EditorPropertyQuantitySwing {
	 ...
	 */
	public EditorPropertySalaryComponentTime(final Application client, final EditorBean bizBeanEditor,
	...
	/**
	 * Adapt the SalaryComponent's time according to the future parent Salary's
	 * time.
	 */
